...
def refinement_loop_with_progress(workflow_image="workflow.jpeg", max_iterations=None):
    ...
    try:
        emit_progress("setup", "Starting Pipeline...", {"model": os.getenv("DEPLOYMENT_NAME", "Not set in .env")})
        ...
        result = pipeline.run_with_options(workflow_image=workflow_image_path, max_iterations=max_iterations)
