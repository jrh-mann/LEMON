...
class TestValidateWorkflowTool:
    ...
    def test_validate_with_subprocess_variables(self):
        ...
        # Variables stored in the unified 'variables' field, including subprocess output
        session_state = {
...
class TestEditToolsPassVariables:
    ...
    def test_delete_connection_with_output_template_variables(self):
    ...
    def test_delete_connection_fails_with_unknown_template_var(self):
    ...
    def test_add_connection_passes_variables(self):
    ...
    def test_delete_node_passes_variables(self):
