"""Regression tests for decision branch selection with empty/missing labels.

These tests preserve behavior around the fallback path used when a decision
node's child edges do not carry explicit True/False labels.
"""
...
class TestEmptyEdgeLabelBranchSelection:
    ...
    def test_empty_edge_labels_false_condition_takes_wrong_branch(self):
        """Regression: empty edge labels must still select the false branch."""
        # Workflow with empty edge labels (historical regression scenario)
        workflow = {
            "inputs": [
                {
                    "id": "bmi",
        ...
        # Regression assertion: false condition should map to "Normal"
    ...
    def test_missing_edge_labels_false_condition_takes_wrong_branch(self):
        """Regression: missing edge_label keys must still select false branch."""
        ...
        assert result.success is True, f"Execution failed: {result.error}"
        # Regression assertion: false condition should map to "Not Senior"
...
class TestAllComparatorsWithEmptyLabels:
    ...
    @pytest.mark.parametrize(
        "comparator,value,input_val,expected_branch",
        [
            # Less than tests
    ...
    def test_comparator_with_empty_labels(
        self, comparator, value, input_val, expected_branch
    ):
